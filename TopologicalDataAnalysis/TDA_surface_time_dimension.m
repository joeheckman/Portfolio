%%%CODE SAMPLE. THIS SCRIPT VISUALIZES TOPOLOGICAL PATTERNS IN RAT EEG THROUGH TIME WHERE TIME ELAPSED IS A DIMENSION OF THE SURFACE (SEE RESULT IN PORTFOLIO).
